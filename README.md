...
- **[implement](./skills/engineering/implement/SKILL.md)** — Implement a piece of work based on a PRD or set of issues, using `/tdd` at pre-agreed seams and reviewing at the end.
...
- **[resolving-merge-conflicts](./skills/engineering/resolving-merge-conflicts/SKILL.md)** — Resolve an in-progress git merge/rebase conflict: find the intent behind both sides, preserve each where possible, then run the project's checks and finish the merge.
