...
- **[install-marketplace-skills](./skills/engineering/install-marketplace-skills/SKILL.md)** — Install skills from the marketplace with dependency resolution and setup guidance.
